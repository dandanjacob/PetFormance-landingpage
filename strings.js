...
const S = {
  ...
  services: {
    ...
    management: {
      ...
      mosaic: [
        { area: "a", label: "Gerenciamento de Redes Sociais",       color: "#1F8FD4", video: "https://drive.google.com/file/d/14lUJfG5cXu_RZ5eXEldGsm64D59k88rH/preview", body: "Cuidamos do dia a dia das suas redes: publicações, comentários e crescimento orgânico — para que você foque no que faz de melhor, o atendimento." },
